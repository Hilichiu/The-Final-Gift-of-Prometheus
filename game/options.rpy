...
define config.name = _("The Final Gift of Prometheus")
...
define build.name = "TheFinalGiftofPrometheus"
...
define config.save_directory = "TheFinalGiftofPrometheus-1760973087"
