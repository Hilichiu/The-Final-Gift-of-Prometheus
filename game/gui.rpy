...
define gui.text_size = 55 ## KEPT LARGE FOR READABILITY AS REQUESTED ##

## The size of character names.
define gui.name_text_size = 48 ## ADJUSTED ## (was 75)

## The size of text in the game's user interface.
define gui.interface_text_size = 33 ## ADJUSTED ## (was 60)

## The size of labels in the game's user interface.
define gui.label_text_size = 36 ## ADJUSTED ## (was 65)

## The size of text on the notify screen.
define gui.notify_text_size = 24 ## ADJUSTED ## (was 50)

## The size of the game's title.
define gui.title_text_size = 80 ## ADJUSTED ## (was 120)


## Main and Game Menus #########################################################

## The images used for the main and game menus.
define gui.main_menu_background = "gui/title_menu.png"
...
define gui.textbox_height = 320 ## ADJUSTED ## (was 600, original was 278. Increased slightly to fit large text.)
...
define gui.dialogue_ypos = 90 ## ADJUSTED ## (was 110. Moved down to fit inside the visual textbox area.)
...
define gui.choice_button_width = 1720
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(150, 8, 150, 8)
define gui.choice_button_text_font = gui.text_font
define gui.choice_button_text_size = gui.text_size ## This will now inherit 65
